...
type AutoType_complete_argv struct {
	Argv *AutoType_complete `json:"argv"`	
}

//Exported model metadata
var AutoType_complete_md fields.FieldCollection

func AutoType_complete_Model_init() {	
	AutoType_complete_md = fields.GenModelMD(reflect.ValueOf(AutoType_complete{}))
}

//
type AutoType_complete struct {
