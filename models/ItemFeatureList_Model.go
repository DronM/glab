...
func (o *ItemFeatureList) SetNull() {
	o.Id.SetNull()
	o.Name.SetNull()
	o.Name_lat.SetNull()
...
func NewModelMD_ItemFeatureList() *model.ModelMD{
	return &model.ModelMD{Fields: fields.GenModelMD(reflect.ValueOf(ItemFeatureList{})),
		ID: "ItemFeatureList_Model",
