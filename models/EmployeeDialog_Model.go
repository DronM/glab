...
func NewModelMD_EmployeeDialog() *model.ModelMD{
	return &model.ModelMD{Fields: fields.GenModelMD(reflect.ValueOf(EmployeeDialog{})),
		ID: "EmployeeDialog_Model",
		Relation: "employees_dialog",
