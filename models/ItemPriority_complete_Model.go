...
type ItemPriority_complete_argv struct {
	Argv *ItemPriority_complete `json:"argv"`	
}

//Exported model metadata
var ItemPriority_complete_md fields.FieldCollection

func ItemPriority_complete_Model_init() {	
	ItemPriority_complete_md = fields.GenModelMD(reflect.ValueOf(ItemPriority_complete{}))
}

//
type ItemPriority_complete struct {
