...
type ItemFolderFeatureGroupList struct {
...
func (o *ItemFolderFeatureGroupList) SetNull() {
	o.Id.SetNull()
...
func NewModelMD_ItemFolderFeatureGroupList() *model.ModelMD{
	return &model.ModelMD{Fields: fields.GenModelMD(reflect.ValueOf(ItemFolderFeatureGroupList{})),
		ID: "ItemFolderFeatureGroupList_Model",
		Relation: "item_folder_feature_groups_list",
	}
}
