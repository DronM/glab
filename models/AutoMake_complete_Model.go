...
type AutoMake_complete_argv struct {
	Argv *AutoMake_complete `json:"argv"`	
}

//Exported model metadata
var AutoMake_complete_md fields.FieldCollection

func AutoMake_complete_Model_init() {	
	AutoMake_complete_md = fields.GenModelMD(reflect.ValueOf(AutoMake_complete{}))
}

//
type AutoMake_complete struct {
