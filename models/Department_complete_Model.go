...
type Department_complete_argv struct {
	Argv *Department_complete `json:"argv"`	
}

//Exported model metadata
var Department_complete_md fields.FieldCollection

func Department_complete_Model_init() {	
	Department_complete_md = fields.GenModelMD(reflect.ValueOf(Department_complete{}))
}

//
type Department_complete struct {
