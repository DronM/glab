...
type VehicleType_complete_argv struct {
	Argv *VehicleType_complete `json:"argv"`	
}

//Exported model metadata
var VehicleType_complete_md fields.FieldCollection

func VehicleType_complete_Model_init() {	
	VehicleType_complete_md = fields.GenModelMD(reflect.ValueOf(VehicleType_complete{}))
}

//
type VehicleType_complete struct {
