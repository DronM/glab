...
type Supplier_complete_argv struct {
	Argv *Supplier_complete `json:"argv"`	
}

//Exported model metadata
var Supplier_complete_md fields.FieldCollection

func Supplier_complete_Model_init() {	
	Supplier_complete_md = fields.GenModelMD(reflect.ValueOf(Supplier_complete{}))
}

//
type Supplier_complete struct {
