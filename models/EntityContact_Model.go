...
type EntityContact struct {
	...
	Entity_type enums.ValEnum_data_types `json:"entity_type" required:"true"`
	Entity_id fields.ValInt `json:"entity_id" required:"true"`
	Contact_id fields.ValInt `json:"contact_id" required:"true"`
	Mod_date_time fields.ValDateTimeTZ `json:"mod_date_time" required:"true"`
}
...
type EntityContact_old_keys struct {
	...
	Id fields.ValInt `json:"id"`
	Entity_type enums.ValEnum_data_types `json:"entity_type"`
