...
type ItemFolder_complete_argv struct {
	Argv *ItemFolder_complete `json:"argv"`	
}

//Exported model metadata
var ItemFolder_complete_md fields.FieldCollection

func ItemFolder_complete_Model_init() {	
	ItemFolder_complete_md = fields.GenModelMD(reflect.ValueOf(ItemFolder_complete{}))
}

//
type ItemFolder_complete struct {
