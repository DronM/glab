...
type AutoModelGeneration_complete_for_model struct {
...
type AutoModelGeneration_complete_for_model_argv struct {
	Argv *AutoModelGeneration_complete_for_model `json:"argv"`	
}
