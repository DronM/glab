...
type ItemFeature_complete_argv struct {
	Argv *ItemFeature_complete `json:"argv"`	
}

//Exported model metadata
var ItemFeature_complete_md fields.FieldCollection

func ItemFeature_complete_Model_init() {	
	ItemFeature_complete_md = fields.GenModelMD(reflect.ValueOf(ItemFeature_complete{}))
}

//
type ItemFeature_complete struct {
