...
type Item_complete_argv struct {
	Argv *Item_complete `json:"argv"`	
}

//Exported model metadata
var Item_complete_md fields.FieldCollection

func Item_complete_Model_init() {	
	Item_complete_md = fields.GenModelMD(reflect.ValueOf(Item_complete{}))
}

//
type Item_complete struct {
