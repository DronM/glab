...
function Enum_cash_flow_income_types(id,options){
	options = options || {};
...
checked:(options.defaultValue&&options.defaultValue=="bank")}
	...
	Enum_cash_flow_income_types.superclass.constructor.call(this, id, options);
	
}
extend(Enum_cash_flow_income_types,EditSelect);

Enum_cash_flow_income_types.prototype.multyLangValues = {
