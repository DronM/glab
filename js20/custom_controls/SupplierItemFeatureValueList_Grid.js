 ...
 */
function SupplierItemFeatureValueList_Grid(id,options){
	options = options || {};
	var model = new SupplierItemFeatureValueList_Model({
		//"sequences":{"id":0},
	...
	{	
		"model":model,
		"keyIds":["name"],
		"controller":new SupplierItemFeatureValueList_Controller({"clientModel":model}),
		"editInline":true,
		"editWinClass":null,
	...
	SupplierItemFeatureValueList_Grid.superclass.constructor.call(this,id,options);
}
extend(SupplierItemFeatureValueList_Grid, GridAjx);
...
/* public methods */
SupplierItemFeatureValueList_Grid.prototype.getValue = function(){	
	if (this.m_model){
