...
function VehicleType_Model(options){
	var id = 'VehicleType_Model';
	options = options || {};
	...
	options.fields.code.getValidator().setRequired(true);
		...
		VehicleType_Model.superclass.constructor.call(this,id,options);
}
extend(VehicleType_Model,ModelXML);
