...
function Contact_Model(options){
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Email подтвержден';
	filed_options.autoInc = false;	
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Номер телефона подтвержден';
	filed_options.autoInc = false;	
	
	options.fields.tel_confirmed = new FieldBool("tel_confirmed",filed_options);
