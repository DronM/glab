...
function LoginList_Model(options){
	...
	options.fields.sess_create_time = new FieldDateTimeTZ("sess_create_time",filed_options);
	...
	options.fields.sess_accessed_time = new FieldDateTimeTZ("sess_accessed_time",filed_options);
