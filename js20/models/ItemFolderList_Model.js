...
function ItemFolderList_Model(options){
	var id = 'ItemFolderList_Model';
	options = options || {};
	...
	options.fields.item_feature_groups_list = new FieldJSON("item_feature_groups_list",filed_options);
	...
	options.fields.supplier_item_feature_groups_list = new FieldJSON("supplier_item_feature_groups_list",filed_options);
	...
	options.fields.item_priorities_ref = new FieldJSON("item_priorities_ref",filed_options);
		...
		ItemFolderList_Model.superclass.constructor.call(this,id,options);
}
extend(ItemFolderList_Model,ModelXML);
