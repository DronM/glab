...
function AutoModelGeneration_Model(options){
	var id = 'AutoModelGeneration_Model';
	options = options || {};
	...
	options.fields.series = new FieldText("series",filed_options);
		...
		AutoModelGeneration_Model.superclass.constructor.call(this,id,options);
}
extend(AutoModelGeneration_Model,ModelXML);
