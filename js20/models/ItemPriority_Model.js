...
function ItemPriority_Model(options){
	var id = 'ItemPriority_Model';
	options = options || {};
	...
	options.fields.name.getValidator().setRequired(true);
		...
		ItemPriority_Model.superclass.constructor.call(this,id,options);
}
extend(ItemPriority_Model,ModelXML);
