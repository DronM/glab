...
function AutoBodyType_Model(options){
	var id = 'AutoBodyType_Model';
	options = options || {};
	...
	options.fields.name.getValidator().setRequired(true);
		...
		AutoBodyType_Model.superclass.constructor.call(this,id,options);
}
extend(AutoBodyType_Model,ModelXML);
