...
function CashFlowOutList_Model(options){
	var id = 'CashFlowOutList_Model';
	options = options || {};
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		CashFlowOutList_Model.superclass.constructor.call(this,id,options);
}
extend(CashFlowOutList_Model,ModelXML);
