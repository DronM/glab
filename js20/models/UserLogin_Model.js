...
function UserLogin_Model(options){
	var id = 'UserLogin_Model';
	options = options || {};
	...
	options.fields.locale_id = new FieldString("locale_id",filed_options);
	...
	options.fields.pwd = new FieldString("pwd",filed_options);
	...
	options.fields.ban_hash = new FieldString("ban_hash",filed_options);
		...
		UserLogin_Model.superclass.constructor.call(this,id,options);
}
extend(UserLogin_Model,ModelXML);
