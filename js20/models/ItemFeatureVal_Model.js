...
function ItemFeatureVal_Model(options){
	var id = 'ItemFeatureVal_Model';
	options = options || {};
	...
	options.fields.item_id.getValidator().setRequired(true);
	...
	options.fields.date_time.getValidator().setRequired(true);
		...
		ItemFeatureVal_Model.superclass.constructor.call(this,id,options);
}
extend(ItemFeatureVal_Model,ModelXML);
