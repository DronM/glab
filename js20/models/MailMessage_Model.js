...
function MailMessage_Model(options){
	var id = 'MailMessage_Model';
	options = options || {};
	...
	options.fields.error_str = new FieldText("error_str",filed_options);
		...
		MailMessage_Model.superclass.constructor.call(this,id,options);
}
extend(MailMessage_Model,ModelXML);
