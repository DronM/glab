...
function FinExpenseTypeList_Model(options){
	var id = 'FinExpenseTypeList_Model';
	options = options || {};
	...
	options.fields.deleted = new FieldBool("deleted",filed_options);
		...
		FinExpenseTypeList_Model.superclass.constructor.call(this,id,options);
}
extend(FinExpenseTypeList_Model,ModelXML);
