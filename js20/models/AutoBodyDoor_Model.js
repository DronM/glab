...
function AutoBodyDoor_Model(options){
	var id = 'AutoBodyDoor_Model';
	options = options || {};
	...
	options.fields.name_full = new FieldText("name_full",filed_options);
		...
		AutoBodyDoor_Model.superclass.constructor.call(this,id,options);
}
extend(AutoBodyDoor_Model,ModelXML);
