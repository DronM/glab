...
function BankFlowInList_Model(options){
	var id = 'BankFlowInList_Model';
	options = options || {};
	...
	options.fields.firms_ref = new FieldJSON("firms_ref",filed_options);
	...
	var filed_options = {};
	filed_options.primaryKey = false;	
	filed_options.alias = 'Номер платежносго поручения';
	filed_options.autoInc = false;	
	
	options.fields.pp_num = new FieldText("pp_num",filed_options);
	
		BankFlowInList_Model.superclass.constructor.call(this,id,options);
}
extend(BankFlowInList_Model,ModelXML);
