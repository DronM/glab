...
function SupplierStoreList_Model(options){
	var id = 'SupplierStoreList_Model';
	options = options || {};
	...
	options.fields.supplier_name = new FieldString("supplier_name",filed_options);
	...
	options.fields.name_api = new FieldText("name_api",filed_options);
		...
		SupplierStoreList_Model.superclass.constructor.call(this,id,options);
}
extend(SupplierStoreList_Model,ModelXML);
