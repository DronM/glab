...
function BankFlowOutDialog_Model(options){
	var id = 'BankFlowOutDialog_Model';
	options = options || {};
	...
	options.fields.pp_num = new FieldText("pp_num",filed_options);
		...
		BankFlowOutDialog_Model.superclass.constructor.call(this,id,options);
}
extend(BankFlowOutDialog_Model,ModelXML);
