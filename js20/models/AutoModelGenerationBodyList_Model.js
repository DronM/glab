...
function AutoModelGenerationBodyList_Model(options){
	var id = 'AutoModelGenerationBodyList_Model';
	options = options || {};
	...
	options.fields.local_id.getValidator().setMaxLength('10');
		...
		AutoModelGenerationBodyList_Model.superclass.constructor.call(this,id,options);
}
extend(AutoModelGenerationBodyList_Model,ModelXML);
