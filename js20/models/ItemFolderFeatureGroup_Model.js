...
function ItemFolderFeatureGroup_Model(options){
	var id = 'ItemFolderFeatureGroup_Model';
	options = options || {};
	...
	options.fields.item_feature_group_id = new FieldInt("item_feature_group_id",filed_options);
		...
		ItemFolderFeatureGroup_Model.superclass.constructor.call(this,id,options);
}
extend(ItemFolderFeatureGroup_Model,ModelXML);
