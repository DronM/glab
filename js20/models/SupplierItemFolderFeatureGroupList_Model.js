...
function SupplierItemFolderFeatureGroupList_Model(options){
	var id = 'SupplierItemFolderFeatureGroupList_Model';
	options = options || {};
	...
	options.fields.item_feature_groups_ref = new FieldJSON("item_feature_groups_ref",filed_options);
		...
		SupplierItemFolderFeatureGroupList_Model.superclass.constructor.call(this,id,options);
}
extend(SupplierItemFolderFeatureGroupList_Model,ModelXML);
