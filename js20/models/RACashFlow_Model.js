...
function RACashFlow_Model(options){
	var id = 'RACashFlow_Model';
	options = options || {};
	...
	filed_options.enumValues = 'cash_flow_in,cash_flow_out';
	...
	options.fields.cash_location_id.getValidator().setRequired(true);
	...
	options.fields.total.getValidator().setMaxLength('15');
		...
		RACashFlow_Model.superclass.constructor.call(this,id,options);
}
extend(RACashFlow_Model,ModelXML);
