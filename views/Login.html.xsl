					...
					<form id="Login">
						<div class="panel panel-body login-form">
							...
							<!-- slate-300-->
								...
								<h5 class="content-group">Лаборатория Автостекла<small class="display-block">Авторизация</small></h5>
								<div id="Login:error"></div>
							</div>

							<div class="form-group has-feedback has-feedback-left">
								<input id="Login:user" type="text" class="form-control" placeholder="Имя пользователя"/>
