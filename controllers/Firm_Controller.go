...
func NewController_Firm() *Firm_Controller{
	c := &Firm_Controller{gobizap.Base_Controller{ID: "Firm", PublicMethods: make(gobizap.PublicMethodCollection)}}	
	...
	c.PublicMethods["insert"] = &Firm_Controller_insert{
		gobizap.Base_PublicMethod{
			...
			EventList: gobizap.PublicMethodEventList{"Firm.insert"},
		},
	}
	...
	c.PublicMethods["delete"] = &Firm_Controller_delete{
		gobizap.Base_PublicMethod{
			ID: "delete",
			Fields: keys_fields,
			EventList: gobizap.PublicMethodEventList{"Firm.delete"},
		},
	}
	...
	c.PublicMethods["update"] = &Firm_Controller_update{
		gobizap.Base_PublicMethod{
			...
			EventList: gobizap.PublicMethodEventList{"Firm.update"},
		},
	}
