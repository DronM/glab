...
type ValEnum_cash_flow_income_types struct {
	fields.ValText
}

func (e *ValEnum_cash_flow_income_types) GetValues() []string {
	return []string{ "cash", "bank" }
}

//func (e *ValEnum_cash_flow_income_types) GetDescriptions() map[string]map[string]string {
