...
func (a *GLabApp) setJavaScript(debugMode bool) {
	bs := a.GetBaseDir()
	if debugMode {
		a.JavaScriptModel = httpSrv.NewScriptModel(692)
		...
		a.JavaScriptModel.Rows[0] = &httpSrv.TagScript{Src: "js20/js20/assets/js/core/libraries/jquery.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/assets/js/core/libraries/jquery.min.js")),
		}
		a.JavaScriptModel.Rows[1] = &httpSrv.TagScript{Src: "js20/js20/assets/js/core/libraries/bootstrap.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/assets/js/core/libraries/bootstrap.min.js")),
		}
		a.JavaScriptModel.Rows[2] = &httpSrv.TagScript{Src: "js20/js20/assets/js/plugins/loaders/blockui.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/assets/js/plugins/loaders/blockui.min.js")),
		}
		a.JavaScriptModel.Rows[3] = &httpSrv.TagScript{Src: "js20/js20/assets/js/core/app.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/assets/js/core/app.js")),
		}
		a.JavaScriptModel.Rows[4] = &httpSrv.TagScript{Src: "js20/js20/ext/bootstrap-datepicker/bootstrap-datepicker.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/bootstrap-datepicker/bootstrap-datepicker.min.js")),
		}
		a.JavaScriptModel.Rows[5] = &httpSrv.TagScript{Src: "js20/js20/ext/bootstrap-datepicker/bootstrap-datepicker.ru.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/bootstrap-datepicker/bootstrap-datepicker.ru.min.js")),
		}
		a.JavaScriptModel.Rows[6] = &httpSrv.TagScript{Src: "js20/js20/ext/cleave/cleave.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/cleave/cleave.min.js")),
		}
		a.JavaScriptModel.Rows[7] = &httpSrv.TagScript{Src: "js20/js20/ext/cleave/cleave-phone.ru.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/cleave/cleave-phone.ru.js")),
		}
		a.JavaScriptModel.Rows[8] = &httpSrv.TagScript{Src: "js20/js20/ext/jshash-2.2/md5-min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/jshash-2.2/md5-min.js")),
		}
		a.JavaScriptModel.Rows[9] = &httpSrv.TagScript{Src: "js20/js20/ext/mustache/mustache.min.js",
			Modified: httpSrv.ScriptModifiedTime(filepath.Join(bs, "js20/js20/ext/mustache/mustache.min.js")),
		}
